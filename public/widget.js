    ...
    var renderers = {
        ...
        'horizontal-carousel': function(el, business, reviews) {
            ...
            var cardsHTML = reviews.map(function(r) {
                ...
                return '<div class="opynio-review-card"><div class="opynio-review-header"><div class="opynio-review-user"><div class="opynio-avatar-placeholder">' + (r.original_author_name || 'A').charAt(0).toUpperCase() + '</div><div class="opynio-user-content"><div class="opynio-username">' + (r.original_author_name || 'Anónimo') + '</div>' + badge + '</div></div>' + icon + '</div><div class="opynio-review-stars"><div class="opynio-stars">' + generateStars(r.rating) + '</div></div><p class="opynio-review-text opynio-review-text-truncated" id="' + reviewId + '" style="max-height: 120px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; word-break: break-word;">' + reviewText + '</p><button class="opynio-ver-mas-btn" data-review-id="' + reviewId + '" style="background: none; border: none; color: #00b67a; cursor: pointer; font-size: 0.85rem; font-weight: 600; padding: 0.25rem 0; margin-top: 0.5rem; text-decoration: underline;">Ver más</button></div>';
            }).join('');
