...
(function() {
    ...
    var renderers = {
        ...
        'horizontal-carousel': function(el, business, reviews) {
            var ratingText = (business.avg_rating || 0) >= 4.5 ? 'EXCELENTE' : (business.avg_rating || 0) >= 3.5 ? 'MUY BUENO' : 'BUENO';
