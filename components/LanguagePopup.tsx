...
const languageNames: Record<string, Record<string, string>> = {
    ...
    vi: { es: 'Tiếng Tây Ban Nha', en: 'Tiếng Anh (US)', gb: 'Tiếng Anh (UK)', au: 'Tiếng Anh (AU)', br: 'Tiếng Bồ Đào Nha (BR)', pt: 'Tiếng Bồ Đào Nha (PT)', fr: 'Tiếng Pháp', de: 'Tiếng Đức', it: 'Tiếng Ý', ca: 'Tiếng Catalan', cn: 'Tiếng Trung', sv: 'Tiếng Thụy Điển', pl: 'Tiếng Ba Lan', ja: 'Tiếng Nhật', vi: 'Tiếng Việt' },
...
const countryNames: Record<string, Record<string, string>> = {
    ...
    vi: { ES: 'Tây Ban Nha', MX: 'Mexico', AR: 'Argentina', CO: 'Colombia', CL: 'Chile', PE: 'Peru', VE: 'Venezuela', EC: 'Ecuador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panama', UY: 'Uruguay', US: 'Hoa Kỳ', GB: 'Vương quốc Anh', BR: 'Brazil', PT: 'Bồ Đào Nha', FR: 'Pháp', DE: 'Đức', IT: 'Ý', AD: 'Andorra', SE: 'Thụy Điển', PL: 'Ba Lan', JP: 'Nhật Bản', VN: 'Việt Nam' },
