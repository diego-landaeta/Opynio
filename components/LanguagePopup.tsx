...
const languageNames: Record<string, Record<string, string>> = {
    ...
    hi: { es: 'स्पेनिश', en: 'अंग्रेज़ी (US)', gb: 'अंग्रेज़ी (UK)', au: 'अंग्रेज़ी (AU)', br: 'पुर्तगाली (BR)', pt: 'पुर्तगाली (PT)', fr: 'फ़्रेंच', de: 'जर्मन', it: 'इतालवी', ca: 'कैटलन', cn: 'चीनी', sv: 'स्वीडिश', pl: 'पोलिश', ja: 'जापानी', vi: 'वियतनामी', bn: 'बंगाली', hi: 'हिन्दी' },
