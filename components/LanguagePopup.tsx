...
const languageNames: Record<string, Record<string, string>> = {
    ...
    bn: { es: 'স্প্যানিশ', en: 'ইংরেজি (US)', gb: 'ইংরেজি (UK)', au: 'ইংরেজি (AU)', br: 'পর্তুগিজ (BR)', pt: 'পর্তুগিজ (PT)', fr: 'ফরাসি', de: 'জার্মান', it: 'ইতালিয়ান', ca: 'কাতালান', cn: 'চীনা', sv: 'সুইডিশ', pl: 'পোলিশ', ja: 'জাপানি', vi: 'ভিয়েতনামী', bn: 'বাংলা' },
