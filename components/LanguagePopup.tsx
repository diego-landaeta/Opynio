...
const languageNames: Record<string, Record<string, string>> = {
    es: { es: 'Español', en: 'Inglés', br: 'Portugués', fr: 'Francés', de: 'Alemán', it: 'Italiano', ca: 'Catalán', cn: 'Chino' },
    en: { es: 'Spanish', en: 'English', br: 'Portuguese', fr: 'French', de: 'German', it: 'Italian', ca: 'Catalan', cn: 'Chinese' },
    pt: { es: 'Espanhol', en: 'Inglês', br: 'Português', fr: 'Francês', de: 'Alemão', it: 'Italiano', ca: 'Catalão', cn: 'Chinês' },
    br: { es: 'Espanhol', en: 'Inglês', br: 'Português', fr: 'Francês', de: 'Alemão', it: 'Italiano', ca: 'Catalão', cn: 'Chinês' },
    fr: { es: 'Espagnol', en: 'Anglais', br: 'Portugais', fr: 'Français', de: 'Allemand', it: 'Italien', ca: 'Catalan', cn: 'Chinois' },
    de: { es: 'Spanisch', en: 'Englisch', br: 'Portugiesisch', fr: 'Französisch', de: 'Deutsch', it: 'Italienisch', ca: 'Katalanisch', cn: 'Chinesisch' },
    it: { es: 'Spagnolo', en: 'Inglese', br: 'Portoghese', fr: 'Francese', de: 'Tedesco', it: 'Italiano', ca: 'Catalano', cn: 'Cinese' },
    ca: { es: 'Espanyol', en: 'Anglès', br: 'Portuguès', fr: 'Francès', de: 'Alemany', it: 'Italià', ca: 'Català', cn: 'Xinès' },
    zh: { es: '西班牙语', en: '英语', br: '葡萄牙语', fr: '法语', de: '德语', it: '意大利语', ca: '加泰罗尼亚语', cn: '中文' },
    cn: { es: '西班牙语', en: '英语', br: '葡萄牙语', fr: '法语', de: '德语', it: '意大利语', ca: '加泰罗尼亚语', cn: '中文' },
};

// Country names in different languages
const countryNames: Record<string, Record<string, string>> = {
    es: { ES: 'España', MX: 'México', AR: 'Argentina', CO: 'Colombia', CL: 'Chile', PE: 'Perú', VE: 'Venezuela', EC: 'Ecuador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panamá', UY: 'Uruguay', US: 'Estados Unidos', GB: 'Reino Unido', BR: 'Brasil', PT: 'Portugal', FR: 'Francia', DE: 'Alemania', IT: 'Italia', AD: 'Andorra' },
    en: { ES: 'Spain', MX: 'Mexico', AR: 'Argentina', CO: 'Colombia', CL: 'Chile', PE: 'Peru', VE: 'Venezuela', EC: 'Ecuador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panama', UY: 'Uruguay', US: 'United States', GB: 'United Kingdom', BR: 'Brazil', PT: 'Portugal', FR: 'France', DE: 'Germany', IT: 'Italy', AD: 'Andorra' },
    pt: { ES: 'Espanha', MX: 'México', AR: 'Argentina', CO: 'Colômbia', CL: 'Chile', PE: 'Peru', VE: 'Venezuela', EC: 'Equador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panamá', UY: 'Uruguai', US: 'Estados Unidos', GB: 'Reino Unido', BR: 'Brasil', PT: 'Portugal', FR: 'França', DE: 'Alemanha', IT: 'Itália', AD: 'Andorra' },
    br: { ES: 'Espanha', MX: 'México', AR: 'Argentina', CO: 'Colômbia', CL: 'Chile', PE: 'Peru', VE: 'Venezuela', EC: 'Equador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panamá', UY: 'Uruguai', US: 'Estados Unidos', GB: 'Reino Unido', BR: 'Brasil', PT: 'Portugal', FR: 'França', DE: 'Alemanha', IT: 'Itália', AD: 'Andorra' },
    fr: { ES: 'Espagne', MX: 'Mexique', AR: 'Argentine', CO: 'Colombie', CL: 'Chili', PE: 'Pérou', VE: 'Venezuela', EC: 'Équateur', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panama', UY: 'Uruguay', US: 'États-Unis', GB: 'Royaume-Uni', BR: 'Brésil', PT: 'Portugal', FR: 'France', DE: 'Allemagne', IT: 'Italie', AD: 'Andorre' },
    de: { ES: 'Spanien', MX: 'Mexiko', AR: 'Argentinien', CO: 'Kolumbien', CL: 'Chile', PE: 'Peru', VE: 'Venezuela', EC: 'Ecuador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panama', UY: 'Uruguay', US: 'Vereinigte Staaten', GB: 'Vereinigtes Königreich', BR: 'Brasilien', PT: 'Portugal', FR: 'Frankreich', DE: 'Deutschland', IT: 'Italien', AD: 'Andorra' },
    it: { ES: 'Spagna', MX: 'Messico', AR: 'Argentina', CO: 'Colombia', CL: 'Cile', PE: 'Perù', VE: 'Venezuela', EC: 'Ecuador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panama', UY: 'Uruguay', US: 'Stati Uniti', GB: 'Regno Unito', BR: 'Brasile', PT: 'Portogallo', FR: 'Francia', DE: 'Germania', IT: 'Italia', AD: 'Andorra' },
    ca: { ES: 'Espanya', MX: 'Mèxic', AR: 'Argentina', CO: 'Colòmbia', CL: 'Xile', PE: 'Perú', VE: 'Veneçuela', EC: 'Equador', GT: 'Guatemala', CR: 'Costa Rica', PA: 'Panamà', UY: 'Uruguai', US: 'Estats Units', GB: 'Regne Unit', BR: 'Brasil', PT: 'Portugal', FR: 'França', DE: 'Alemanya', IT: 'Itàlia', AD: 'Andorra' },
};
